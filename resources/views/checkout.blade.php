               ...
               <div class="tp-checkout-verify-item">
                  ...
                  <div id="tpReturnCustomerLoginForm" class="tp-return-customer">
                     <form action="#">
                        ...
                        <div class="mb-20 tp-return-customer-suggetions d-sm-flex align-items-center justify-content-between">
               ...
               <div class="tp-checkout-payment">
                  <div class="tp-checkout-payment-item">
                     ...
                     <div class="tp-checkout-payment-desc direct-bank-transfer">
                        <p>Make your payment directly into our bank account. Please use your Order ID as teference. Your order will not be shipped until the funds have cleared in our account.</p>he payment r
                     </div>
                  </div>
                  <div class="tp-checkout-payment-item">
