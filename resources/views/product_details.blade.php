...
<main>
    ...
    <section class="pb-20 breadcrumb__area breadcrumb__style-2 include-bg pt-50">
       <div class="container">
          <div class="row">
             ...
             <div class="row">
                ...
                <div class="col-xl-5 col-lg-6">
                   <div class="tp-product-details-wrapper">
                      ...
                      <div class="flex-wrap tp-product-details-payment d-flex align-items-center justify-content-between">
                                  ...
                                  <div class="col-xl-10">
                                        ...
                                        <div class="row">
                                           <div class="col-lg-6">
                                              ...
                                              <div class="tp-product-details-desc-content">
                                                 ...
                                                 <p>S Pen is a bundle of writing instruments in one. Its natural grip, <br> low latency and impressive pressure sensitivity will make it your go-to for everything from drawing to editing documents. And S Pen wont get misplaced thanks.</p>
                                              </div>
                                           </div>
                                           <div class="col-lg-6">
                                     ...
                                     <div class="tp-product-details-desc-item pb-75">
                                        <div class="row">
                                           ...
                                           <div class="order-first col-lg-5 order-lg-last">
                                              <div class="pl-40 tp-product-details-desc-content des-content-2">
                                     ...
                                     <div class="tp-product-details-desc-item">
                                        <div class="row">
                                           <div class="col-xl-12">
                                              <div class="text-center tp-product-details-desc-banner m-img">
                                  ...
                                  <div class="col-lg-6">
                                     <div class="tp-product-details-review-form">
                                        ...
                                        <form action="#">
                                           ...
                                           <div class="mb-20 tp-product-details-review-suggetions">
    ...
    <section class="tp-related-product pt-95 pb-120">
       <div class="container">
          <div class="row">
             <div class="mb-40 text-center tp-section-title-wrapper-6">
          ...
          <div class="row">
             <div class="tp-product-related-slider">
                <div class="mb-10 tp-product-related-slider-active swiper-container">
