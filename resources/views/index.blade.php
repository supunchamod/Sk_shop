...
<!-- slider area start -->
         ...
         <!-- banner area start -->
         <section class="mt-20 tp-banner-area">
            <div class="container-fluid tp-gx-40">
               <div class="row tp-gx-20">
                  <div class="col-xxl-4 col-lg-6">
                     <div class="mb-20 tp-banner-item-2 p-relative z-index-1 grey-bg-2 fix">
                        <div class="tp-banner-thumb-2 include-bg transition-3" data-background="assets/img/banner/2/banner-1.jpg"></div>
                  ...
                  <div class="col-xxl-4 col-lg-6">
                     <div class="mb-20 tp-banner-item-2 p-relative z-index-1 grey-bg-2 fix">
                        <div class="tp-banner-thumb-2 include-bg transition-3" data-background="assets/img/banner/2/banner-2.jpg"></div>
                        <h3 class="tp-banner-title-2">
                  ...
                  <div class="col-xxl-4 col-lg-6">
                     <div class="mb-20 tp-banner-item-2 p-relative z-index-1 grey-bg-2 fix">
                        <div class="tp-banner-thumb-2 include-bg transition-3" data-background="assets/img/banner/2/banner-3.jpg"></div>
                        <h3 class="tp-banner-title-2">
         ...
         <section class="tp-category-area pb-95 pt-95">
            <div class="container">
               <div class="row">
                  <div class="col-xl-12">
                     <div class="text-center tp-section-title-wrapper-2 mb-50">
                  ...
                  <div class="col-xl-12">
                     <div class="tp-category-slider-2">
                        <div class="tp-category-slider-active-2 swiper-container mb-50">
                           <div class="swiper-wrapper">
                              <div class="text-center tp-category-item-2 p-relative z-index-1 swiper-slide">
         ...
         <section class="tp-product-area pb-90">
            <div class="container">
               <div class="row">
                  <div class="col-xl-12">
                     <div class="text-center tp-section-title-wrapper-2 mb-35">
                        <span class="tp-section-title-pre-2">
                           All Product Shop
                           <svg width="82" height="22" viewBox="0 0 82 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M81 14.5798C0.890564 -8.05914 -5.81154 0.0503902 5.00322 21" stroke="currentColor" stroke-opacity="0.3" stroke-width="2" stroke-miterlimit="3.8637" stroke-linecap="round"/>
               ...
               <div class="row">
                  <div class="col-xl-12">
                     <div class="text-center tp-product-tab-2 tp-tab mb-50">
                        <nav>
                        ...
                        <div class="tab-pane fade show active" id="nav-allCollection" role="tabpanel" aria-labelledby="nav-allCollection-tab" tabindex="0">
                           <div class="row">
                              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                 <div class="mb-40 tp-product-item-2">
                        ...
                        <div class="tp-featured-slider-active swiper-container">
                           <div class="swiper-wrapper">
                              <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                                 <div class="tp-featured-thumb include-bg" data-background="assets/img/product/slider/product-slider-1.jpg"></div>
                              ...
                              <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                                 <div class="tp-featured-thumb include-bg" data-background="assets/img/product/slider/product-slider-2.jpg"></div>
                                 <div class="tp-featured-content">
                                    <h3 class="tp-featured-title">
                              ...
                              <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                                 <div class="tp-featured-thumb include-bg" data-background="assets/img/product/slider/product-slider-3.jpg"></div>
                                 <div class="tp-featured-content">
                                    <h3 class="tp-featured-title">
                              ...
                              <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                                 <div class="tp-featured-thumb include-bg" data-background="assets/img/product/slider/product-slider-4.jpg"></div>
                                 <div class="tp-featured-content">
                                    <h3 class="tp-featured-title">
                              ...
                              <div class="tp-featured-item swiper-slide white-bg p-relative z-index-1">
                                 <div class="tp-featured-thumb include-bg" data-background="assets/img/product/slider/product-slider-5.jpg"></div>
                                 <div class="tp-featured-content">
                                    <h3 class="tp-featured-title">
                                       <a href="product-details.html">Mens Jacket <br> Premium Cotton</a>
                                    </h3>
                                    <div class="tp-featured-price-wrapper">
                  ...
                  <div class="col-xl-6 col-lg-6">
                     <div class="tp-trending-wrapper">
                        ...
                        <div class="tp-trending-slider">
                              ...
                              <div class="swiper-wrapper">
                                 ...
                                 <div class="tp-trending-item swiper-slide">
                                    <div class="tp-product-item-2">
                                       <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                          <a href="product-details.html">
                                             <img src="assets/img/product/trending/trending-2.jpg" alt="">
                                          </a>
                                          <!-- product action -->
                                          <div class="tp-product-action-2 tp-product-action-blackStyle">
                                             <div class="tp-product-action-item-2 d-flex flex-column">
                                       ...
                                       <div class="tp-product-content-2 pt-15">
                                          ...
                                          <h3 class="tp-product-title-2">
                                             <a href="product-details.html">Strip Shirt For Women (Green)</a>
                                          </h3>
                                          <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                             <span><i class="fa-solid fa-star"></i></span>
                                             <span><i class="fa-solid fa-star"></i></span>
                                 ...
                                 <div class="tp-trending-item swiper-slide">
                                    <div class="tp-product-item-2">
                                       <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                          <a href="product-details.html">
                                             <img src="assets/img/product/trending/trending-3.jpg" alt="">
                                          </a>
                                          <!-- product action -->
                                          <div class="tp-product-action-2 tp-product-action-blackStyle">
                                             <div class="tp-product-action-item-2 d-flex flex-column">
                                       ...
                                       <div class="tp-product-content-2 pt-15">
                                          ...
                                          <h3 class="tp-product-title-2">
                                             <a href="product-details.html">Deep Blue Dress </a>
                                          </h3>
                                          <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                             <span><i class="fa-solid fa-star"></i></span>
                                             <span><i class="fa-solid fa-star"></i></span>
                           ...
                           <div class="text-center tp-trending-slider-dot tp-swiper-dot mt-45"></div>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-4 col-lg-5 col-md-8 col-sm-10">
                     <div class="tp-trending-banner p-relative ml-35">
                        <div class="tp-trending-banner-thumb w-img include-bg" data-background="assets/img/product/trending/banner/trending-banner.jpg"></div>
                        <div class="tp-trending-banner-content">
                           ...
                           <div class="tp-trending-banner-btn">
                              <a href="shop.html" class="tp-btn tp-btn-border tp-btn-border-white tp-btn-border-white-sm">
                                 Explore More
                                 <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <section class="tp-seller-area pb-140">
            <div class="container">
               ...
               <div class="row">
                  <div class="col-xl-12">
                     <div class="mt-10 text-center tp-seller-more">
               ...
               <div class="row justify-content-center">
                  <div class="col-xl-12">
                     <div class="tp-testimonial-slider p-relative z-index-1">
                        ...
                        <h3 class="text-center tp-testimonial-section-title">The Review Are In</h3>
                        <div class="row justify-content-center">
                           <div class="col-xl-8 col-lg-8 col-md-10">
                              <div class="tp-testimonial-slider-active swiper-container">
                                 <div class="swiper-wrapper">
                                    <div class="mb-20 text-center tp-testimonial-item swiper-slide">
                                       ...
                                       <div class="tp-testimonial-user-wrapper d-flex align-items-center justify-content-center">
                                          <div class="tp-testimonial-user d-flex align-items-center">
                                             <div class="mr-10 tp-testimonial-avater">
                        ...
                        <div class="text-center tp-testimonial-slider-dot tp-swiper-dot mt-30 tp-swiper-dot-style-darkRed d-md-none"></div>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class="col-xl-4 col-lg-4 col-md-6">
                     <div class="mb-40 tp-blog-item-2">
               ...
               <div class="row">
                  <div class="col-xl-12">
                     <div class="mt-10 text-center tp-blog-more-2">
                  ...
                  <div class="row align-items-center">
                     <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="tp-feature-item-2 d-flex align-items-start">
                           <div class="mr-10 tp-feature-icon-2">
                              <span>
         ...
         <section class="tp-instagram-area">
            <div class="pl-20 pr-20 container-fluid">
               <div class="row row-cols-lg-5 row-cols-sm-2 row-cols-1 gx-2 gy-2 gy-lg-0">
                  ...
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/2/insta-2.jpg" alt="">
                        <div class="tp-instagram-icon-2">
                  ...
                  <div class="col">
                     <div class="text-center tp-instagram-banner">
                           <div class="mb-40 tp-instagram-banner-icon">
                              <a href="#">
                                 <img src="assets/img/instagram/2/insta-icon.png" alt="">
                              </a>
                           </div>
                  ...
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/2/insta-3.jpg" alt="">
                        <div class="tp-instagram-icon-2">
                  ...
                  <div class="col">
                     <div class="tp-instagram-item-2 w-img">
                        <img src="assets/img/instagram/2/insta-4.jpg" alt="">
                        <div class="tp-instagram-icon-2">
               ...
               <div class="modal-content">
                  <div class="tp-product-modal-content d-lg-flex align-items-start">
                        ...
                        <nav>
                           <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                              <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                                 <img src="assets/img/product/details/3/nav/product-details-nav-1.jpg" alt="">
                              </button>
                              <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" type="button" role="tab" aria-controls="nav-2" aria-selected="false">
                                 <img src="assets/img/product/details/3/nav/product-details-nav-2.jpg" alt="">
                              </button>
                              <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3" type="button" role="tab" aria-controls="nav-3" aria-selected="false">
                                 <img src="assets/img/product/details/3/nav/product-details-nav-3.jpg" alt="">
                              </button>
                              <button class="nav-link" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4" type="button" role="tab" aria-controls="nav-4" aria-selected="false">
                                 <img src="assets/img/product/details/3/nav/product-details-nav-4.jpg" alt="">
                              </button>
                           </div>
                        </nav>
                        <div class="tab-content m-img" id="productDetailsNavContent">
                           <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="assets/img/product/details/3/main/product-details-main-1.jpg" alt="">
                              </div>
                           </div>
                           <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="assets/img/product/details/3/main/product-details-main-2.jpg" alt="">
                              </div>
                           </div>
                           <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="assets/img/product/details/3/main/product-details-main-3.jpg" alt="">
                              </div>
                           </div>
                           <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab" tabindex="0">
                              <div class="tp-product-details-nav-main-thumb">
                                 <img src="assets/img/product/details/3/main/product-details-main-4.jpg" alt="">
                              </div>
                           </div>
                         </div>
                     </div>
                     <div class="tp-product-details-wrapper">
                        ...
                        <!-- inventory details -->
                        <div class="mb-10 tp-product-details-inventory d-flex align-items-center">
                           <div class="mb-10 tp-product-details-stock">
                              <span>In Stock</span>
                           </div>
                           <div class="mb-10 tp-product-details-rating-wrapper d-flex align-items-center">
                        ...
                        <!-- price -->
                        <div class="mb-20 tp-product-details-price-wrapper">
